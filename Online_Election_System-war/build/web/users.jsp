...
<t:layout>
    ...
    <jsp:body>
        ...
        <div class="flex mt-7 justify-between px-4">
                                                ...
                                                <td class="text-sm text-gray-900 px-6 py-4 whitespace-nowrap">
                                                    <div class="flex justify-center items-center">
                                                        ...
                                                        <c:if test="${profile.status == false}">
                                                            ...
                                                            <button data-bs-toggle="modal" data-bs-target="#approveUserModal" type="button" class="approveUserButton inline-block mr-3 px-6 py-2.5 bg-purple-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-purple-700 hover:shadow-lg focus:bg-purple-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-purple-800 active:shadow-lg transition duration-150 ease-in-out">Approve</button>

                                                        </c:if>
                                                        <button style="background-color: rgb(234 179 8);" type="button" data-bs-toggle="modal" data-bs-target="#updateUserModal" class="updateUserButton mr-3 inline-block px-6 py-2.5 bg-yellow-500 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-yellow-600 hover:shadow-lg focus:bg-yellow-600 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-yellow-700 active:shadow-lg transition duration-150 ease-in-out">Update</button>
                                                        <button type="button" data-bs-toggle="modal" data-bs-target="#deleteUserModal" class="deleteUserButton inline-block px-6 py-2.5 bg-red-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-red-700 hover:shadow-lg focus:bg-red-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-red-800 active:shadow-lg transition duration-150 ease-in-out">Delete</button>
                                                    </div>
                                                </td>
                                            </tr>
                                        </c:forEach>
